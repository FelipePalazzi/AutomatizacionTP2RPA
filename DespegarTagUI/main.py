#Codigo en python para el envio de los mensajes a un canal de discord
import requests
import json
import os
ruta = os.getcwd()
ruta=ruta[0].upper()+ruta[1:]+"\\DespegarTagUI"

file_path = (ruta+"\\out\\Ezeiza-Madrid\\TablaPrecios.png").replace('/', '\\').replace('\\', '\\\\')
print(file_path)
...
path_vuelo1 = ruta+"\\out\\Ezeiza-Madrid\\Vuelo1.png"

path_vuelo2 = ruta+"\\out\\Ezeiza-Madrid\\Vuelo2.png"
path_vuelo3 = ruta+"\\out\\Ezeiza-Madrid\\Vuelo3.png"
